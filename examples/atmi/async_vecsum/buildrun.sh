...
echo g++ -O3  -o vecsum sumKernel.o vecsum.cpp -lsnk -L$SNACK_RUNTIME_PATH/lib -L $HSA_RUNTIME_PATH/lib -lhsa-runtime64 -lelf 
g++ -O3  -o vecsum sumKernel.o vecsum.cpp -lsnk -L$SNACK_RUNTIME_PATH/lib -L $HSA_RUNTIME_PATH/lib -lhsa-runtime64 -lelf 
