...
echo "g++ -o csquares csquares.o csquares.cpp -lsnk -L$SNACK_RUNTIME_PATH/lib -L$HSA_RUNTIME_PATH/lib -lhsa-runtime64 -lelf -I$SNACK_INC"
#g++ -o csquares csquares.o csquares.cpp -lsnk -L$HSA_RUNTIME_PATH/lib -lhsa-runtime64 -lelf 
g++ -o csquares csquares.o csquares.cpp -lsnk -L$SNACK_RUNTIME_PATH/lib -L$HSA_RUNTIME_PATH/lib -lhsa-runtime64 -lelf -I$SNACK_INC 
