...
echo g++ -o fibonacci fibonacci.o fibonacci.cpp -O3 -lelf -L$SNACK_RUNTIME_PATH/lib -lsnk -L$HSA_RUNTIME_PATH/lib -lhsa-runtime64 
g++ -o fibonacci fibonacci.cpp -g fibonacci.o -O3 -lelf -L$SNACK_RUNTIME_PATH/lib -lsnk -L$HSA_RUNTIME_PATH/lib -lhsa-runtime64 
