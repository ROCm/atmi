...
g++-4.9 -c -o HelloWorld.o HelloWorld.cpp -g -fplugin=atmi_pifgen.so -fplugin-arg-atmi_pifgen-clfile=hw.cl -O3 -I$ATMI_INC

./kl_genw.sh hw.cl 0.9.0 . update.cl

cat kernel_wrapper.c >> HelloWorld.cpp.pifdefs.c
...
g++-4.9 -o hello HelloWorld.o HelloWorld.cpp.pifdefs.c -g -O3 -lelf -L$ATMI_RUNTIME_PATH/lib -latmi_runtime -L$HSA_RUNTIME_PATH/lib -lhsa-runtime64 -I$ATMI_INC -I$HSA_RUNTIME_PATH/include
