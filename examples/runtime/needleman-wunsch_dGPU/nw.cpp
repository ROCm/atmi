...
int main(int argc, char **argv){
    ...
    atmi_malloc((void **)&d_reference, max_rows * max_cols * sizeof(int), gpu);
    atmi_memcpy(d_reference, reference, max_rows * max_cols * sizeof(int));
    atmi_malloc((void **)&d_input_itemsets, max_rows * max_cols * sizeof(int), gpu);
    atmi_memcpy(d_input_itemsets, input_itemsets, max_rows * max_cols * sizeof(int));
    ...
    //int *tmp_var = new int;
    int *tmp_var;
    atmi_malloc((void **)&tmp_var, sizeof(int), cpu);
    *tmp_var = 0;
    ...
    atmi_memcpy(output_itemsets, d_input_itemsets, max_rows * max_cols * sizeof(int));
...
#define TRACEBACK
    ...
    atmi_free(d_reference);
    atmi_free(d_input_itemsets);
    free(reference);
    free(input_itemsets);
