...
echo "g++ -o CSquares CSquares.o CSquares.cpp -L$HSA_RUNTIME_PATH/lib/x86_64 -lhsa-runtime64 -lelf "
g++ -o CSquares CSquares.o CSquares.cpp -L$HSA_RUNTIME_PATH/lib/x86_64 -lhsa-runtime64 -lelf 
