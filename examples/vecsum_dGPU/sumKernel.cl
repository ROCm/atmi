...
__kernel void sum8192Kernel_gpu(atmi_task_handle_t thisTask, __global const INT_TYPE * x,  __global INT_TYPE * result) {
...
__kernel void sum8192KernelN_gpu(atmi_task_handle_t thisTask, __global const INT_TYPE * x, __global INT_TYPE * result, const int N) {
   __local INT_TYPE buffer[512];
   int gid=get_local_id(0) ;
   buffer[gid] = 0;
